...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName('evi')
    .setDescription('Displays information about Evi'),
    ...
    .addFields(
      {
        ...
        value: 'Please note that Evi is currently in alpha development, and slash commands may not function as intended.',
        inline: false
      },
      {
        name: '📥 Invite me!',
